...
typedef struct {
  /* State of Charge Estimation based on Coulumb Counting */
  real32_T SOC_CC[96];

  /* State of Charge Estimation based on Extended Kalman Filter */
  real32_T SOC_EKF;
} SOC_Est;
...
typedef struct tag_RTM_SOC_Estimation_T RT_MODEL_SOC_Estimation_T;

#endif                                 /* RTW_HEADER_SOC_Estimation_types_h_ */
has popup